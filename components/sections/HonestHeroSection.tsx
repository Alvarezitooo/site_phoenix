  ...
  return (
    <div className="hero-honest bg-gradient-to-r from-purple-600 to-indigo-700 text-white py-20 px-4 text-center">
      ...
      <div className="early-adopter-cta mt-8">
        <a href="https://phoenix-creator.netlify.app/" target="_blank" rel="noopener noreferrer" className="btn-primary bg-white text-purple-700 hover:bg-gray-100 font-bold py-3 px-8 rounded-full text-lg transition duration-300 ease-in-out shadow-lg">
