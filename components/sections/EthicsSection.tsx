            ...
            <CardContent className="pt-8">
              <div className="text-center">
                ...
                <p className="text-lg text-slate-700 leading-relaxed max-w-3xl mx-auto">
                  Phoenix propose des outils gratuits puissants. Les fonctionnalités premium financent 
                  le développement et ma subsistance. À terme, 10% des revenus financeront un fonds 
                  solidaire pour offrir des abonnements aux personnes les plus précaires.
                </p>
              </div>
            </CardContent>
          </Card>
